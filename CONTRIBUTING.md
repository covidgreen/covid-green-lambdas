...
| `@covidgreen/core`  |  Core development  |  `covid-green-lambdas` |
...
1. Open a pull request to [`covidgreen/covid-green-app:current`](https://github.com/covidgreen/covid-green-lambdas/pulls) that adds your name, username, and email to the team you have choosen in the [README.md](./README.md). The members lists are sorted alphabetically; make sure to add your name in the proper order.
...
1. If the collaborator can't work with us anymore, they should:
  1. Open a pull request to [`covidgreen/covid-green-lambdas:current`](https://github.com/covidgreen/covid-green-lambdas/pulls) and move themselves in the *Past Collaborators* section.
